...
const About = () => {
    return (
        <div>
            ...
            <h3>I'm super excited to start the next chapter of my working life working as a front-end developer and ultimately full-stack. It's early days, but i already know this was the best decision. </h3>
            <AboutPicture2 />
        </div>
    );
};
